...
class AddRecipeView extends View {
	...
	addHandlerHideWindow(handler) {
		this._btnClose.addEventListener(`click`, handler.bind());
	...
	addHandlerUpload(handler) {
		this._parentElement.addEventListener(`submit`, function (e) {
			...
			const dataOb = Object.fromEntries(dataArr); // Remark: fromEntries is opposite of entries
			handler(dataOb);
		});
	}
